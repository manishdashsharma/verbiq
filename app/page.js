    ...
    <div className="min-h-screen bg-black text-white">
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <Button
            size="lg"
            className="bg-green-600 hover:bg-green-700 text-black font-semibold px-8 py-3 text-lg"
            onClick={() => window.location.href = '/auth/signin'}
          >
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center">
              <div className="bg-green-600 rounded-full w-16 h-16 flex items-center justify-center mx-auto mb-4">
                <IconUpload className="h-8 w-8 text-black" />
              </div>
            ...
            <div className="text-center">
              <div className="bg-green-600 rounded-full w-16 h-16 flex items-center justify-center mx-auto mb-4">
                <IconEye className="h-8 w-8 text-black" />
              </div>
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            ...
            <div className="relative">
              ...
              <div className="relative flex h-full flex-col overflow-hidden rounded-2xl border-2 border-green-500/50 bg-zinc-900/80 backdrop-blur-sm p-8 shadow-2xl min-h-[500px]">
                <div className="relative z-50">
                  ...
                  <div className="flex items-baseline mb-8">
                    ...
                    <span className="text-xl text-zinc-400 ml-2">/month</span>
                  </div>
            ...
            <div className="relative">
              ...
              <div className="relative flex h-full flex-col overflow-hidden rounded-2xl border border-zinc-700 bg-zinc-900/60 backdrop-blur-sm p-8 shadow-xl min-h-[500px] opacity-75">
                <div className="relative z-50">
